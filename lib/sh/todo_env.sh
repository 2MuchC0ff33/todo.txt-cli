...
# shellcheck disable=SC2250,SC2086,SC2164,SC2154,SC2312,SC2249,SC2094,SC2034
set -eu
: "${TODO_DIR:=$HOME/.todo}"
: "${TODO_FILE:=$TODO_DIR/todo.txt}"
: "${DONE_FILE:=$TODO_DIR/done.txt}"
: "${REPORT_FILE:=$TODO_DIR/report.txt}"
: "${TODO_DB:=$TODO_DIR/todo.db}"
: "${TODOTXT_VERBOSE:=1}"
: "${TODOTXT_FORCE:=0}"
: "${TODOTXT_PLAIN:=0}"
...
export TODO_DIR TODO_FILE DONE_FILE REPORT_FILE TODO_DB
